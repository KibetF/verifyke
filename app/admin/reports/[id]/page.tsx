      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/admin/reports" className="text-sm text-slate-500 hover:text-slate-700">
              ← All Reports
            </Link>
          </div>
          <PrintButton />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4 text-sm">
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{report.serviceRequest.user.email}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4 text-sm">
              ...
              <div className="space-y-2">
                <div>
                  <p className="text-slate-500">Name</p>
                  <p className="font-medium">{report.agent.fullName}</p>
                </div>
                <div>
                  <p className="text-slate-500">Email</p>
                  <p className="font-medium">{report.agent.email}</p>
                </div>
                <div>
